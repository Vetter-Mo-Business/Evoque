...
export const ui = {
  de: {
    ...
    'nav.brandHome': 'EVOQUE – Yourself, zur Startseite',
    'nav.primary': 'Hauptnavigation',
    'nav.menuOpen': 'Menü öffnen',
    'nav.menuClose': 'Menü schließen',
    'slider.roledescription': 'Karussell',
    ...
    'home.testi.t1.quote':
      'Ich habe mich jederzeit zu 100% wohl gefühlt, die Fragen zur Selbstreflexion waren perfekt abgestimmt. Meine größte Erkenntnis war, warum ich welche Verhaltensweisen ausführe.',
    'home.testi.t1.author': 'Kundin, 22',
    'home.testi.t1.topic': 'Thema: Prokrastination',
    'home.testi.t1.period': 'Begleitung: 2026',
    'home.testi.t1.ratingLabel': '5 von 5 Sternen',
  ...
  en: {
    ...
    'nav.brandHome': 'EVOQUE – Yourself, to the home page',
    'nav.primary': 'Main navigation',
    'nav.menuOpen': 'Open menu',
    'nav.menuClose': 'Close menu',
    'slider.roledescription': 'Carousel',
    ...
    'home.testi.t1.quote':
      'I felt 100% comfortable at all times, and the questions for self-reflection were perfectly tailored. My biggest insight was understanding why I act the way I do.',
    'home.testi.t1.author': 'Client, 22',
    'home.testi.t1.topic': 'Topic: Procrastination',
    'home.testi.t1.period': 'Guidance: 2026',
    'home.testi.t1.ratingLabel': '5 out of 5 stars',
